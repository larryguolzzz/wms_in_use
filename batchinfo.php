...
if (isset($_POST['dhl'])) {
    ...
    echo "<script>window.open('exportbatch.php?type=dhl&id=" . $batch . " ')</script>";
}
if (isset($_POST['dhl_invoice'])) {

    echo "<script>window.open('exportbatch.php?type=dhl_invoice&id=" . $batch . " ')</script>";
}
?>
                                            ...
                                            <div class="header-top-menu tabl-d-n">
                                                <div class="breadcome-heading">
                                                    ...
                                                    <div style="color:#fff;width:px;float:right;">
                                                        <button name="dhl" title="DHL运单文件" type="submit" class="pd-setting-ed">导出DHL运单文件</button>

                                                    </div> <div style="color:#fff;width:px;float:right;">
                                                        <button name="dhl_invoice" title="DHL发票文件" type="submit" class="pd-setting-ed">导出DHL发票文件</button>
