...
//      else {
                                                            for ($index = 0; $index < @count(@$pendingdata); $index++) {
                                                                ...
                                                                $pendingservicefee = $pendingdata[$index]['servicefee'] * $ratio;
                                                                print "<td>{$pendingdata[$index]['shippingcost']}</td>";
                                                                print "<td>{$pendingservicefee}";
                                                                ?>
...
//      else {/*
                                                            ...
                                                            for ($shippedindex = 0; $shippedindex < @count($shippeddata); $shippedindex++) {
                                                                ...
                                                                $shippedservicefee = $shippeddata[$shippedindex]['servicefee'] * $ratio;
                                                                print "<td>{$shippedservicefee}</td>";
                                                                $service_unpaid_shipped = $service_unpaid_shipped + $shippedservicefee;
...
//      else {
                                                            for ($index = 0; $index < @count($paiddata); $index++) {
                                                                ...
                                                                $paidservicefee = $paiddata[$index]['servicefee'] * $ratio;
                                                                print "<td> {$paidservicefee }</td>";
