...
$code = $Bar->getBarcode($_SESSION['detailbar'], $Bar::TYPE_CODE_39);
$sncode = $Bar->getBarcode(@$sn, $Bar::TYPE_CODE_39);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="row">
                <div class="col-md-6 " style="background: white; padding: 0px;">
                    <div class="panel-heading">
                        ...
                        <p> <i class="fa fa-pencil-square-o" aria-hidden="true">5.Feel free to contact us using the chat system on Marketplace if you have any issues.</i></p>
