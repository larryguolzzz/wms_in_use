                            ...
                            <div class="product-status-wrap">
                                ...
                                <form method="post" role="search" class="">
                                    ...
                                    <table >
                                        ...
                                        <tr>
                                            <th>日期/date</th>
                                            <th>市场/Market Place</th>
                                            <th>订单号/Order Number</th>
                                            <th>主题/Subject</th>
                                            <th>新记事/New Note</th>
                                            <th>设置/Setting</th>
                                        </tr>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel-body">          
                            <form method="post">
                                <div>
                                    <h4>添加新通知</h4>
                                    <label class="control-label" for="username">订单号/Order Number</label>
                                ...
                                <label class="control-label">主题/Subject</label>
                                <input type="text" title="" placeholder="Notes" required="" value="" name="password" id="new" class="form-control">


                                <div>
                                    <input type="submit" name="submit" value="提交" class="btn btn-success btn-block loginbtn">  
