...
if (isset($_POST["save"])) {
    $isku = trim(@$_POST["isku"]);
    $ibatch = trim(@$_POST['ibatch']);
    $icategory = trim(@$_POST['icategory']);
    $ireceiver = trim(@$_POST["ireceiver"]);
    $iaddress = trim(@$_POST["iaddress"]);
    $iaddress2 = trim(@$_POST["iaddress2"]);
    $icity = trim(@$_POST["icity"]);
    $istate = trim(@$_POST["istate"]);
    $izipcode = trim(@$_POST["izipcode"]);
    $iphone = trim(@$_POST["iphone"]);
    $iweight = trim(@$_POST["iweight"]);
    $inote = trim(@$_POST["inote"]);
