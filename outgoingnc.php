...
if (@isset($_POST['confirm']) && @count($_SESSION['tosend']) != 0) {
    if ($_POST['subject'] == "order") {
        ...
        $sql = "INSERT INTO `ncstock`(date, productlist, subject, ordernumber, market, tracking, ship, cmpid) VALUES ('" . $str . "','" . $productlist . "','order' ,'" . $_POST['orderno'] . "','" . $_POST['mkt'] . "','" . $_POST['trackno'] . "','" . $_POST['ship'] . "','" . $cmpid . "')";
        $result = mysqli_query($conn, $sql);
        if ($result) {
            ...
            for ($i = 0; $i < count($pro); $i++) {
                ...
                $sql = "UPDATE product SET sold=sold+" . $pro[$i][1] . " where (cmpid='" . $cmpid . "') AND sku='" . $pro[$i][0] . "'";
                mysqli_query($conn, $sql);
            }
        ...
        $productlist = json_encode($_SESSION['tosend']);
        $sql = "INSERT INTO `ncstock`(date, productlist, subject, ordernumber, market, tracking, ship, cmpid) VALUES ('" . $str . "','" . $productlist . "','replacement' ,'" . $_POST['orderno'] . "','" . $_POST['mkt'] . "','" . $_POST['trackno'] . "','" . $_POST['ship'] . "','" . $cmpid . "')";
        $result = mysqli_query($conn, $sql);
        if ($result) {
            $pro = json_decode($productlist);
            for ($i = 0; $i < count($pro); $i++) {
                                        ...
                                        <form action="" method="post" name="form" enctype="multipart/form-data">
                                            <div><h1 style="color:#fff">PICK UP FROM CURRENT INVENTORY</h1>
                                                ...
                                                <table style="width: 90%;margin:auto;color: #fff">
                                                    ...
                                                    <tr>
                                                        <th><a style="color: #fff" href="outgoingnc.php?column=sku&order=<?php echo $asc_or_desc; ?>">Product SKU <i class=" fa fa-sort<?php echo $column == 'sku' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                                                        <th><a style="color: #fff" href="outgoingnc.php?column=ncorder=<?php echo $asc_or_desc; ?>">Inventory <i class=" fa fa-sort<?php echo $column == 'nc' ? '-' . $up_or_down : ''; ?>"></i></a></th>
...
//这段控制pickup表格
                                            ...
                                            <div class="custom-pagination "  >
                                                ...
                                                <span style="color:#fff;margin-right:1.25em"><input name="subject" type="radio" value="order" checked="">New Order</span>
                                                <span style="color:#fff;margin-right:1.25em"><input name="subject" type="radio" value="replacement">Replacement<br></span>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" style="color:#fff">Traking No.</label>
                                                <input type="text"  title="You need to input tracking No to confirm" required="" value="" name="trackno" id="username" class="form-control">
                                                <span style="color:#fff;margin-right:1.25em"><input name="ship" type="radio" value="USPS" checked>USPS</span>
                                                ...
                                                <span style="color:#fff;margin-right:1.25em"><input name="ship" type="radio" value="DHL" >DHL</span>
