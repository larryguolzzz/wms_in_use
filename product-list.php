...
$columns = array('sku', 'brand', 'category', 'price', 'ram', 'cpu', 'quality');
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-status-wrap">
                                ...
                                <div class="add-product" >                                    
                                    ...
                                    <a  href="product-edit.php">添加商品</a>
                                </div>
                                <div>
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                ...
                                <form action="" method="post" name="form">
                                    ...
                                    <table >
                                        ...
                                        <tr>
                                            <th><a style="color: #fff" href="product-list.php?column=sku&order=<?php echo $asc_or_desc; ?>">商品SKU <i class=" fa fa-sort<?php echo $column == 'sku' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                                            <th><a style="color: #fff" href="product-list.php?column=ram&order=<?php echo $asc_or_desc; ?>">标题/Title <i class="fa fa-sort<?php echo $column == 'ram' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                                            <th><a style="color: #fff" href="product-list.php?column=brand&order=<?php echo $asc_or_desc; ?>">品牌/Brand <i class=" fa fa-sort<?php echo $column == 'brand' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                                            <th><a style="color: #fff" href="product-list.php?column=category&order=<?php echo $asc_or_desc; ?>">ASIN <i class="fa fa-sort<?php echo $column == 'category' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                                            <th><a style="color: #fff" href="product-list.php?column=cpu&order=<?php echo $asc_or_desc; ?>">FNSKU <i class="fa fa-sort<?php echo $column == 'cpu' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                                            <th><a style="color: #fff" href="product-list.php?column=price&order=<?php echo $asc_or_desc; ?>">价格/Original Price <i class="fa fa-sort<?php echo $column == 'price' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                                            <th><a style="color: #fff" href="product-list.php?column=quality&order=<?php echo $asc_or_desc; ?>">NOTE <i class="fa fa-sort<?php echo $column == 'quality' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                                            <th>设置/settings</th>
                                        </tr>
