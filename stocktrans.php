...
if (@isset($_POST['confirm']) && @count($_SESSION['todo']) != 0) {
    ...
    $sql = "INSERT INTO shstock(date, productlist, subject, ship, tracking, ordernumber,log,cmpid) VALUES ('" . $str . "','" . $productlist . "','export' ,'" . $_POST['ship'] . "','" . $_POST['dhl'] . "','1','" . $_POST['note'] . "','" . $cmpid . "')";

    $result = mysqli_query($conn, $sql);
    if ($result) {
        $sql = "INSERT INTO note (date, subject,status,cmpid) VALUES (' " . $str . "',' STOCK TRANSFER:" . $_POST['dhl']."_".$_POST['ship'] . "+NOTE:" . $_POST['note'] . "','1', '" . $cmpid . "')";
        ;
